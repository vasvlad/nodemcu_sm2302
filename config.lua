...
-- WiFi Configuration
config.targetSSID = "WiFiSSID" 					-- The name that your wifi is broadcasting
...
config.PASSWD = "xxxxx"							-- MQTT Password
...
config.PUBINTERVAL = 10000						-- How often the sensor should publish its readings, in milliseconds. 
